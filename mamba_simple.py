...
try:
    from mamba_ssm.ops.selective_scan_interface import selective_scan_fn, mamba_inner_fn, bimamba_inner_fn, mamba_inner_fn_no_out_proj  #why
except ImportError:
    selective_scan_fn, mamba_inner_fn, bimamba_inner_fn, mamba_inner_fn_no_out_proj = None, None, None, None 
if selective_scan_fn is None:
    print("selective_scan_fn 没有被导入")
else:
    print("selective_scan_fn 有被导入")
if mamba_inner_fn is None:
    print("mamba_inner_fn 没有被导入")
else:
    print("mamba_inner_fn 有被导入")
if bimamba_inner_fn is None:
    print("bimamba_inner_fn 没有被导入")
else:
    print("bimamba_inner_fn 有被导入")
if mamba_inner_fn_no_out_proj is None:
    print("mamba_inner_fn_no_out_proj 没有被导入")
else:
    print("mamba_inner_fn_no_out_proj 有被导入")
